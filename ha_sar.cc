...
static handler *sar_create_handler(handlerton *hton, TABLE_SHARE *table,
...
static int sar_init_func(void *p) {
  ...
  sar_hton->flags = HTON_CAN_RECREATE;
...
Example_share *ha_sar::get_share() {
...
ha_sar::ha_sar(handlerton *hton, TABLE_SHARE *table_arg)
...
int ha_sar::open(const char *, int, uint, const dd::Table *) {
...
*/
int ha_sar::update_row(const uchar *, uchar *) {
...
int ha_sar::delete_row(const uchar *) {
...
int ha_sar::index_read_map(uchar *, const uchar *, key_part_map,
...
*/
void ha_sar::position(const uchar *) {
...
*/
int ha_sar::rnd_pos(uchar *, uchar *) {
  int rc;
...
*/
THR_LOCK_DATA **ha_sar::store_lock(THD *, THR_LOCK_DATA **to,
...
*/
int ha_sar::delete_table(const char *, const dd::Table *) {
...
int ha_sar::create(const char *name, TABLE *, HA_CREATE_INFO *,
                       dd::Table *) {
  ...
  */
  ...
  /*
    It's just an sar of THDVAR_SET() usage below.
  */
  THD *thd = ha_thd();
...
static SYS_VAR *sar_system_variables[] = {
...
mysql_declare_plugin(sar){
    ...
    sar_system_variables, /* system variables */
    NULL,                     /* config options */
    0,                        /* flags */
